...
router.post("/login", AuthMiddleware.verifyUser, AuthMiddleware.createToken);
router.post("/tags", AuthMiddleware.verifyToken, tags_controller.AddTags);
...
router.delete("/posts/:id(\\d+)", AuthMiddleware.verifyToken, delete_controller.deleteRecord);
